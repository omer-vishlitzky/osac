...
func main() {
	...
	// Metrics endpoint is enabled in the Helm chart's deployment template. The Metrics options configure the server.
	// More info:
	...
	//
	// TODO(user): If you enable certManager, configure the Helm chart values
